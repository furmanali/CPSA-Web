...
class Subscription extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, sub_name, hits_allowed, price, durations_in_days, date_created, date_modified', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'subscriptionLogs' => array(self::HAS_MANY, 'SubscriptionLog', 'subscription_id'),
			'usersDetails' => array(self::HAS_MANY, 'UsersDetails', 'current_subscription_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('hits_allowed',$this->hits_allowed);
